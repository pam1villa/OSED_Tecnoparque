...
<div class="row">
    ...
    <div class="col-md-4 mt-4">
        <div class="card bg-cover text-below" style="background-image: url(' {{asset('img/perfil1.png')}}')" >
        <div class="card-body z-index-2 py-6 pt-10">
            <h3 class="text-white">Limpieza a profundidad</h3>
            <p class="text-white">
                Si así lo consideras, incluye la limpieza de griferías, sanitarios y mamparas en profundidad. Como en la cocina, vaciar sus muebles y baldas, ...
    ...
    <div class="col-md-4 mt-4">
        <div class="card bg-cover text-below" style="background-image: url('https://demos.creative-tim.com/test/argon-dashboard-pro/assets/img/img-3.jpg')" >
        <div class="card-body z-index-2 py-6 pt-10">
            <h3 class="text-white">Limpieza a profundidad</h3>
            <p class="text-white">
                Si así lo consideras, incluye la limpieza de griferías, sanitarios y mamparas en profundidad. Como en la cocina, vaciar sus muebles y baldas, ...
