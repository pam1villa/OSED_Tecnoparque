          ...
          <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
            <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
              <div class="card z-index-0">
                ...
                <div class="card-body">
                  <form method="POST" action="/Users/edit/{{$user->id}}" role="form">
                    ...
                    <div class="mb-3">
                      <input type="text" class="form-control" value="{{ $user->cedula }}" placeholder="Cedula" aria-label="id" name="cedula">
                    </div>
                    <div class="mb-3">
                      <input type="email" class="form-control" value="{{ $user->email }}" placeholder="Correo Electronico" aria-label="email" name="email">
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" value="{{ $user->phone }}" placeholder="Telefono" aria-label="phone" name="phone">
                    </div>
                    
                    <div class="mb-3">
                      <input type="password" class="form-control" value="{{ $user->password }}" placeholder="Contraseña" aria-label="password" name="password">
                    </div>
