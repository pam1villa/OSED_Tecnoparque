      ...
      <table class="table align-items-center mb-0">
        <thead>
          <tr>
            ...
            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Duración servicio</th>
        ...
        <td class="align-middle text-center">
          ...
          @foreach ($agendaservices as $agendaservice)  
          <tr>
            <td>
              <div class="d-flex px-2 py-1">
                <div class="d-flex flex-column justify-content-center">
                    <span class="mb-0 text-xs"> {{  $agendaservice->service }} </span> 
                </div>
              </div>
            </td>
            <td>
                <p class="text-xs font-weight-bold mb-0">CC</p>
                <span class="text-xs text-secondary mb-0"> {{  $user->hours }} </span> 
            </td>
            <td class="align-middle text-center text-sm">
                <span class="text-xs font-weight-bold mb-0"> {{  $agendaservice->location }} </span>
            </td>
            <td class="align-middle text-center">
                <span class="text-secondary text-xs font-weight-bold">{{  $agendaservice->date }}</span>
            </td>
            <td class="align-middle">
                {{-- route('DeleteAprendiz', $user->id)  --}}
